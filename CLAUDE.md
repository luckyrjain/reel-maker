...
- `reels` — master concept; `status` tracks generation phase; `tts_voice` (nullable) is a per-reel edge-tts voice override, `None` = provider default (see Key conventions)
